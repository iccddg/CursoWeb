...
<head>
    ...
    <meta name="description" content="Esta pagina se hizo con el curso de Jacobo Amaru">
    <meta name="keywords" content="Pagina, practica, sencilla">
    <title>Inicio - Pequeña Pagina</title>
...
<body>
    <header>
        <div class="container">
            <a href="index.html">
                <img src="Img/logo.svg" class="logo" alt="Logo-CocaCola">
            </a>
            <nav>
    ...
    <main>
        <section id="inicio">
            ...
            <div class="bloque-inicio">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
                    Phasellus aliquam finibus felis, nec varius tortor eleifend 
                    nec. Vivamus rutrum bibendum nunc at ullamcorper.
                </p>
        ...
        <section id="nosotros" class="seccion">
            <div class="container">
                <p>Nunc volutpat turpis ac ornare tincidunt. Nam interdum finibus 
                auctor. Morbi ultricies mollis est, ac semper metus semper in. 
                Donec rutrum, elit ut consectetur sodales, nulla augue dictum mi, 
                non lobortis nisi augue non lacus. Sed ut diam et risus 
            ...
            <div class="container">
                <div class="row ">
                    <div class="columna columna-33 columna-mobile-100">
                        <div class="bloque-servicio">
                            <div class="bloque-img-servicio cuadrado-perfecto">
                                <img src="img/servicio1.jpg" alt="imagen de servicio 1">
                            </div>
                    ...
                    <div class="columna columna-33 columna-mobile-100">
                        <div class="bloque-servicio">
                            <div class="bloque-img-servicio cuadrado-perfecto">
                                <img src="img/servicio2.jpg" alt="imagen de servicio 2">
                            </div>
                            <div class="bloque-contenido-servicio">
                                <h3>Servicio 2
                                </h3>
                    ...
                    <div class="columna columna-33 columna-mobile-100">
                        <div class="bloque-servicio">
                            <div class="bloque-img-servicio cuadrado-perfecto">
                                <img src="img/servicio3.jpg" alt="imagen de servicio 3">
                            </div>
                            <div class="bloque-contenido-servicio">
                                <h3>Servicio 3
                                </h3>
                ...
                <div class="row">
                    <div class="columna-33 columna-mobile-50">
                        <div class="cuadrado-perfecto">
                            <img src="img/servicio1.jpg" alt="imagen del servicio 1">
                            <h4>Imagen1
                            </h4>
                        </div>
                    </div>
                    <div class="columna-33 columna-mobile-50">
                        <div class="cuadrado-perfecto">
                            <img src="img/servicio2.jpg" alt="imagen del servicio 2">
                            <h4>Imagen2
                            </h4>
                        </div>
                    </div>
                    <div class="columna-33 columna-mobile-50">
                        <div class="cuadrado-perfecto">
                            <img src="img/servicio3.jpg" alt="imagen del servicio 3">
                            <h4>Imagen3
                            </h4>
                        </div>
                    </div>
        ...
        <section id="contactenos" class="seccion">
            <iframe src="https://maps.google.com/maps?width=520&amp;height=400&amp;hl=en&amp;q=%20Tepic+(Nayarit,%20M%C3%A9xico)&amp;t=&amp;z=12&amp;ie=UTF8&amp;iwloc=B&amp;output=embed" 
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="columna columna-25 columna-mobile-100">
                    ...
                    <ul>
                        <li>cupidoalfa@gmail.com</li>
                        <li>123 456 890</li>
                        <li>Calle fulana de tal numero tal<br>Nayarit México</li>
                    </ul>
                </div>
                <div class="columna columna-25 columna-mobile-100">
                    <h3>
